...
public class Fss_Smack2 {
	...
	//testActivity
	private TestActivity.MyHandler nhandler; 
	//发送状态
	...
	*/
	...
	public Fss_Smack2(Context context,TestActivity.MyHandler nhandlers) {
		try {
			CON.connect();
							...
							mchat.addMessageListener(new MessageListener() {						
								...
								public void processMessage(Chat mChat, Message mMessage) {
									...
									if(!PacketId.equals(mMessage.getPacketID())&&mMessage.getBody()!=null){
										...
										TestActivity.content="接受到的信息是:"+mMessage.getBody()+"\n";
										nhandler.sendEmptyMessage(1);
										System.out.println(TestActivity.content+PacketId);
									}
	...
	public void sendMessage(String content){
		...
		flag=true;
		Tochat.createChat("newuser@coderss.cn",new mMessage());	
		
		
	}

	class mMessage implements MessageListener{
