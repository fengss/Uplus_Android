...
import cn.coderss.iphonetreeview.IphoneTreeView.IphoneTreeHeaderAdapter;
...
public class RosterAdapter extends BaseExpandableListAdapter implements
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.contact_list_group,
					null);
		}
		...
		groupName.setText(TextUtils.isEmpty(group.getGroupName()) ? "我的好友" : group.getGroupName());
		...
		convertView.setTag(R.id.p01, groupPosition);
		convertView.setTag(R.id.c02, -1);
		return convertView;
	}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (convertView == null
			...
			convertView = mInflater.inflate(
					R.layout.contact_list_group_item, parent, false);
			holder.headView = (ImageView) convertView
					.findViewById(R.id.icon);
			holder.statusView = (ImageView) convertView
					.findViewById(R.id.stateicon);
			holder.jid=(TextView)convertView.
					findViewById(R.id.contact_item_jid);
		...
		holder.jid.setText(roster.getJid());
		...
		convertView.setTag(R.id.p02, groupPosition);
		convertView.setTag(R.id.c03, childPosition);
		return convertView;
	}
	...
	public void configureTreeHeader(View header, int groupPosition,
		...
		((TextView) header.findViewById(R.id.group_name)).setText(TextUtils
				.isEmpty(group.getGroupName()) ? "我的好友" : group.getGroupName());
